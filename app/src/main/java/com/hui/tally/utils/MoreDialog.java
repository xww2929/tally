...
import com.hui.tally.MonthChatActivity;
...
public class MoreDialog extends Dialog implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if(view.getId()==R.id.dialog_more_btn_about){
            intent.setClass(getContext(), AboutActivity.class);
            getContext().startActivity(intent);
        }else if(view.getId()==R.id.dialog_more_btn_setting){
            intent.setClass(getContext(), SettingActivity.class);
            getContext().startActivity(intent);
        }else if(view.getId()==R.id.dialog_more_btn_record){
            intent.setClass(getContext(), HistoryActivity.class);
            getContext().startActivity(intent);
        }else if(view.getId()==R.id.dialog_more_btn_info){
            intent.setClass(getContext(), MonthChatActivity.class);
            getContext().startActivity(intent);
        }else if(view.getId()==R.id.dialog_more_iv){
